...
# Add try except for query db TODO
from django.db.models import F, Value, Case, When, CharField, Sum
...
def _get_grouped_orders(orders):
    grouped_orders = {}
    for order in orders:
...
# Create the title by concatenating the string with ' report'
    ...
    # Iterate over each lunch item to gather order data
